...
CREATE TABLE PARKS (
	...
	BARBEQUE_GRILLS NUMBER(1) NOT NULL,
	BASKETBALL_COURTS NUMBER(1) NOT NULL,
	...
	HIKING_TRAILS NUMBER(1) NOT NULL,
	HORSESHOES NUMBER(1) NOT NULL,
	NATURAL_AREA NUMBER(1) NOT NULL,
	OFFLEASH_DOG_PARK NUMBER(1) NOT NULL,
	OPEN_FIELDS NUMBER(1) NOT NULL,
	PICNIC_SHELTERS NUMBER(1) NOT NULL,
	PICNIC_TABLES NUMBER(1) NOT NULL,
	PLAY_AREA NUMBER(1) NOT NULL,
	RESTROOMS NUMBER(1) NOT NULL,
	SCENIC_VIEW_POINT NUMBER(1) NOT NULL,
	SOCCER_FIELDS NUMBER(1) NOT NULL,
	TENNIS_COURTS NUMBER(1) NOT NULL,
...
INSERT INTO PARKS (NAME, STREET_ADDRESS, CITY, STATE, ZIP, LATITUDE, LONGITUDE, OWNER_ID,
	...
	OPEN_FIELDS, PICNIC_SHELTERS, PICNIC_TABLES, PLAY_AREA, RESTROOMS, SCENIC_VIEW_POINT, SOCCER_FIELDS,
